...
|===
| Speicherprotokoll | dir | fs | netfs | logisch | disk | iscsi | iscsi-direct 


| mpath | SMB/CIFS | Ja | Nein | Ja | Nein | Nein | Nein 


| Nein | Nein | NFS | Ja | Nein | Ja | Nein | Nein 


| Nein | Nein | Nein | iSCSI | Ja | Ja | Nein | Ja 


| Ja | Ja | Ja | Ja | FC | Ja | Ja | Nein 


| Ja | Ja | Nein | Nein | Ja | NVMe-oF | Ja | Ja 
|===
