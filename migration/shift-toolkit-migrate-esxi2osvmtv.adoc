...
* VMDKs können auf verschiedene Arten konfiguriert werden: Alle VMDKs können sich auf einem einzigen Volume befinden (wodurch die Notwendigkeit für Storage vMotion entfällt), jede VMDK kann auf einem eigenen Volume platziert werden oder mehrere VMDKs können innerhalb eines qtree in einem Volume organisiert werden.
+
