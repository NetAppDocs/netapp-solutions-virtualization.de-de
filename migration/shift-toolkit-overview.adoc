...
Das Shift-Toolkit kann heruntergeladen werden.link:https://mysupport.netapp.com/site/tools/tool-eula/vm-data-collector["hier,"] und ist nur für Windows-Systeme verfügbar.
