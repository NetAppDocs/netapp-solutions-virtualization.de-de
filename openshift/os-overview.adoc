...
. Befolgen Sie die von Red Hat bereitgestellten link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.22#Install["Installationsanweisungen"] Anweisungen, um die Bereitstellung in Ihrer gewünschten Umgebung durchzuführen.
