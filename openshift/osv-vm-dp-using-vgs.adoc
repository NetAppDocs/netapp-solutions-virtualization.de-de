...
.Schritte
. Die Installation von OpenShift Cluster Version 4.19 erfolgt gemäß den Anweisungen in der Red Hat Dokumentation: https://docs.redhat.com/en/documentation/openshift_container_platform/4.19#Install["Installieren der OpenShift Container Platform"].
