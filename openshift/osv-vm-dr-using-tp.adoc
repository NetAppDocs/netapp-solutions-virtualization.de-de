...
---
= Failover und Failback für VMs in Red Hat OpenShift Virtualization mit Trident Protect einrichten
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
* Trident Protect muss installiert sein, um Failover- und Failback-Operationen für die OpenShift VMs zu implementieren. Anweisungen dazu finden Sie hier link:https://docs.netapp.com/us-en/trident/trident-protect/trident-protect-installation.html["Trident Protect installieren"]


image:redhat-openshift-ocpv-tp-001.png["OCP-v Trident Protect im Namespace trident-protect installiert"]
...
Dieser Abschnitt zeigt, wie man ein AppVault-Objekt in Trident Protect mithilfe von ONTAP S3-Objektspeicher einrichtet.

Verwenden Sie die oc-Befehle und die unten aufgeführten yaml-Dateien, um ein Secret und die AppVault Custom Resource für ONTAP s3 zu erstellen. Stellen Sie sicher, dass Sie sie im Namespace trident protect erstellen.
