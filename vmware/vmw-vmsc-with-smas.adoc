...
. Aktualisieren Sie die Hostdaten, um sie mit ONTAP Tools zu synchronisieren, und dannlink:https://docs.netapp.com/us-en/ontap-tools-vmware-vsphere-10/configure/create-vvols-datastore.html#create-a-vmfs-datastore["Erstellen eines Datenspeichers"] .image:vmware-vmsc-with-smas-017.png["Hostdaten aktualisieren"]
